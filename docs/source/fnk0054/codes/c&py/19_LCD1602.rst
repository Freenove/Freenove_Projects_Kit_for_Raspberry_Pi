...
.. py:function:: lcdPuts(int handle, char *string) 
.. py:function:: lcdPrintf(int handle, char *message, ...)
...
.. note::
    ...
    :combo:`red font-bolder:After the program runs, if nothing displays or the display is not clear, try rotating the white knob on back of LCD1602 slowly, which adjusts the contrast, until the screen can display the Time and Temperature clearly.`
...
.. py:function:: Module LCD1602.CharLCD1602()
