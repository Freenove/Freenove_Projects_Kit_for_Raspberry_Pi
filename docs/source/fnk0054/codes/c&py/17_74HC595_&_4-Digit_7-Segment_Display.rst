...
.. literalinclude:: ../../../freenove_Kit/Code/Python_GPIOZero_Code/17_1_SevenSegmentDisplay/SevenSegmentDisplay.py
    :linenos: 
    :language: python
    :dedent:
...
In the for loop of the loop() function, the 74HC595 IC chip is used to output the position of the ninumber in turn, and the contents of the num array. You can run the showSevenSegmentDisplay command to correctly display the corresponding characters.
