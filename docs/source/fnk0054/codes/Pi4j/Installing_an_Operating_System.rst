...
Monitor desktop
================================================================
If you do not have a spare monitor, please skip to next section :ref:`Remote desktop & VNC <PI4J_Remote>`. If you have a spare monitor, please follow the steps in this section. 
...
:ref:`MAC OS remote desktop <PI4J_MAC>` and :ref:`Windows OS remote desktop <PI4J_Windows>`.
...
Then you can skip to :ref:`VNC Viewer & VNC <PI4J_Viewer>`.
