...
Or you can enter a command in the terminal to open the file Sketch_13_1_1_LCD. :combo:`red font-bolder:(The following is only one line of command. There is a Space after Processing.)`
...
.. note::
    ...
    :combo:`red font-bolder:If you cannot see anything on the display or the display is not clear, try rotating the white knob on back of LCD1602 slowly, which adjusts the contrast, until the screen can display the Time and Data clearly.`
