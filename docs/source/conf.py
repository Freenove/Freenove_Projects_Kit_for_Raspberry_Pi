...
os.system("git clone --depth 1 https://github.com/Freenove/Freenove_Projects_Kit_for_Raspberry_Pi freenove_Kit")
...
html_logo = "fnk0054/codes/_static/imgs/freenove-logo.png"
html_theme_options = {
